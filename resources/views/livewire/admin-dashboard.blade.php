<div class="admin-dash-wrap">
    ...
    <div class="card pro-card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-pro mb-0">
                    ...
                    <tbody>
                        ...
                        $cfg = $mapSemaforo[$estadoKey] ?? ['class'=>'sema-gris','desc'=>'Sin clasificación'];
                        @endphp
                        <tr>
            ...
            <div class="legend-box">
                ...
                <div class="legend-item"><span class="legend-dot dot-amarillo"></span> Amarillo: Enviado / En revisión / Reenviado</div>
                <div class="legend-item"><span class="legend-dot dot-rojo"></span> Rojo: Rechazado / Requiere corrección</div>
    ...
    ->orderByDesc('indicadores_asignados')
    ->get();
    @endphp
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    <div class="dep-card">
                        <div class="dep-card-top">
                            ...
                            <span class="badge-soft">{{ (int)$row->indicadores_asignados }} ind</span>
                        </div>
                        ...
                        <div class="dep-mini">
                            <div class="dep-mini-label">Carga de trabajo</div>
                            @php
                            $maxF = max(1, (int)($depIndicadores->max('formularios_asociados') ?? 1));
                            $pct = (int) round(((int)$row->formularios_asociados / $maxF) * 100);
                            @endphp
                            <div class="dep-bar">
                                <div class="dep-bar-fill" style="width: {{ $pct }}%"></div>
                            </div>
                            <div class="text-muted small mt-2">Relativo al máximo ({{ $maxF }})</div>
                        </div>
