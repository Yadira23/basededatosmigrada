                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div>
                            <input wire:model.live='keyWord' type="text" class="form-control" name="search"
                                id="search" placeholder="Buscar Dependencias">
                        </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a data-bs-toggle="modal" data-bs-target="#DataModal"
                                                            class="dropdown-item"
                                                            wire:click="edit({{ $row->id_depen }})"><i
                                                                class="bi-pencil-square"></i> Edit </a></li>
                                                    <li><a class="dropdown-item"
                                                            onclick="confirm('Confirm Delete Dependencia id {{ $row->id_depen }}? \nDeleted Dependencias cannot be recovered!')||event.stopImmediatePropagation()"
                                                            wire:click="destroy({{ $row->id_depen }})"><i
