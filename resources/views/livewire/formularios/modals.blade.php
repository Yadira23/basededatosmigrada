        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DataModalLabel">
                    {{ $selected_id ? 'Update Formulario' : 'Create Formulario' }}</h5>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.defer="descripcion_form" type="text" class="form-control"
                            id="descripcion_form" placeholder="Descripcion Form">
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.defer="boton_accion_form" type="hidden" class="form-control"
                            id="boton_accion_form" placeholder="Boton Accion Form">
                        @error('boton_accion_form')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input wire:model.defer="secciones_form" type="text" class="form-control" id="secciones_form"
                            placeholder="Secciones Form">
                        @error('secciones_form')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label>Periodo (viene del indicador)</label>
                        <input type="text" class="form-control"
                            value="{{ $periodo_form ?: 'Selecciona un indicador' }}" readonly>
                        <small class="text-muted">
                            Este campo se asigna automáticamente según el periodo del indicador.
                        </small>
                    </div>
                    <div class="form-group">
