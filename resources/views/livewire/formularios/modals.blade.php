            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.defer="boton_accion_form" type="hidden" class="form-control" id="boton_accion_form" placeholder="Boton Accion Form">@error('boton_accion_form') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Periodo</label>
                        <select wire:model.defer="periodo_form" class="form-control">
